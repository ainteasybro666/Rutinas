...
data class Action(
    ...
    val id: Long = 0,
    val uuid: String = UUID.randomUUID().toString(), // UUID generado aquí
    val type: String,
    val routineId: Long,
    @ColumnInfo(name = "data")
    val data: @RawValue Map<String, Any> = emptyMap(), // @RawValue en la propiedad
    ...
    companion object {
        fun createAction( // UUID ya no es un parámetro, se genera en el constructor
            routineId: Long,
